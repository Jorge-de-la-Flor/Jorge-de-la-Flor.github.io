...
- Software en Python y Rust (con `embedded-hal` y tooling afín)  
- **Modelos de Micro IA** y pipelines ligeros para correr en el borde  
...
- **Sistemas embebidos** con `embedded-hal` y ecosistema Rust embedded  
- **Micro IA / Edge AI** sobre microcontroladores y dispositivos de bajo recurso  
- Desarrollo de **frameworks y librerías** que simplifican trabajar con hardware y modelos en el edge  

---

<p>
  <a href="{{ '/' | relative_url }}" class="cta-link">← Volver al inicio</a>
</p>
