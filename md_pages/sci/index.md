...
<!-- Snake Code Institute Section -->
  <section class="section snake-section {% if page.mode != 'crab' %}active{% endif %}" id="snake-section">
    ...
    <div class="content-section" id="temario-python">
      <div class="container">
        <h2 class="section-title">Lo que dominaras</h2>
    ...
    <span class="keyword">def</span> <span class="function">process</span>(<span class="variable">self</span>, data: <span class="type">DataFrame</span>) -> <span class="type">Result</span>:
        ...
        <div class="modules-grid">
          ...
          <div class="module-card">
            ...
            <p class="module-desc">Parametros, scope, decoradores, closures</p>
          </div>
          <div class="module-card">
          ...
          <div class="module-card">
            ...
            <p class="module-desc">Metodos especiales, dataclasses, ABC</p>
          </div>
          <div class="module-card">
            <span class="module-num">06</span>
            <h3 class="module-title">SOLID</h3>
            <p class="module-desc">Principios de diseno de software</p>
          </div>
          <div class="module-card">
          ...
          <div class="module-card">
            ...
            <p class="module-desc">Aplicacion completa con arquitectura limpia</p>
          </div>
        </div>
      </div>
    </div>